...
\begin{description}
    ...
    \item[BAF] Batch Annealing Furnace; warmtebehandelingsinstallatie en bijhorende planningsmodule binnen ArcelorMittal.
    ...
    \item[PLAPO] Planbare populatie, interne benaming voor het lijnplanningsplatform van ArcelorMittal.
