...
Het schema benadrukt dat het framework niet alleen een lineair stappenplan is, maar ook iteratief werkt: bevindingen uit Component~2 tot en met Component~4 kunnen teruggevoerd worden naar Component~1 en leiden tot een toegenomen betrouwbaarheid van de migratie.
