...
steeds duurder en risicovoller. Binnen ArcelorMittal vormt de Batch Annealing Furnace (BAF), een
...
analysefase voor het ontsluiten van CA~Gen-modellen, (2)~vertaalrichtlijnen tussen
...
%de PoC functioneel equivalente output produceert. 
Het framework biedt ArcelorMittal een herhaalbare en
...
De validatie van het framework via een Parallel Run toonde aan dat de gemigreerde PL/I-module functioneel vergelijkbare output oplevert als het CA~Gen-origineel. Kleine verschillen in veldwaarden zijn terug te voeren op detailfouten in de logica en kunnen met beperkte inspanning worden opgelost. Dit bevestigt dat het framework een solide basis biedt voor gecontroleerde migraties, maar dat optimalisatie mogelijk blijft voor specifieke logica.

Het antwoord op de centrale onderzoeksvraag luidt dan ook dat een high-level framework, opgebouwd uit analyse, vertaalschema's, best practices en validatie, effectief richting geeft aan het migratieproces van CA~Gen naar PL/I. Het framework is geen automatische codegenerator, maar een praktische leidraad die IT-professionals ondersteunt bij het gestructureerd en reproduceerbaar uitvoeren van migraties. Voor ArcelorMittal betekent dit een verminderd risico op kennisverlies en een verhoogde efficiëntie bij toekomstige migraties.

Aanbevolen wordt om het framework verder te verfijnen op basis van toekomstige migratiecases en de opgedane ervaringen te documenteren. De aanpak is bovendien inzetbaar voor andere legacy-migraties, mits aanpassing van de vertaaltabellen en validatiestrategie aan de doeltaal en context.
