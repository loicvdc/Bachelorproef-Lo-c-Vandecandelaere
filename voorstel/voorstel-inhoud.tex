...
Veel organisaties maken vandaag nog gebruik van legacy-applicaties die ontwikkeld zijn met Cool:Gen, een modelgedreven ontwikkeltool die in het verleden wijdverspreid werd ingezet voor bedrijfskritische systemen. Hoewel deze applicaties doorgaans stabiel functioneren, vormt de verouderde technologie in combinatie met een sterk afnemende beschikbaarheid van Cool:Gen-expertise een belangrijk knelpunt voor onderhoud, performantie-optimalisatie en verdere evolutie. \hl{Binnen de context van deze bachelorproef vormt een concrete Cool:Gen-applicatie binnen een industriële bedrijfsomgeving (Arcelor Mittal) de uitgangssituatie voor het onderzoek.}
...
De centrale probleemstelling in deze casus is dat de huidige Cool:Gen-applicatie sterk afhankelijk is van specifieke tooling en schaarse kennis, wat leidt tot verhoogde onderhoudsrisico’s en beperkte flexibiliteit bij aanpassingen of optimalisaties. Bovendien ontbreekt een gestructureerde en herbruikbare aanpak om dergelijke applicaties op een gecontroleerde manier te analyseren en te migreren. Vanuit deze probleemstelling wordt volgende centrale onderzoeksvraag geformuleerd: \hl {Hoe kan een generiek en herbruikbaar high-level migratieframework worden opgesteld om Cool:Gen-applicaties systematisch te analyseren, reverse-engineeren en migreren naar een andere programmeertaal, en in welke mate ondersteunt dit framework een correcte en efficiënte migratie?}
...
In een eerste fase wordt de huidige probleemsituatie in kaart gebracht door middel van documentanalyse en overleg met betrokken IT-professionals binnen de organisatie. \hl {Welke rol speelt Cool:Gen binnen het applicatielandschap? Welke functionele en architecturale componenten bevat de Cool:Gen-applicatie?} Zijn twee centrale vragen. De officiële Cool:Gen-documentatie van Broadcom en interne bedrijfsdocumentatie vormen de primaire informatiebronnen voor deze analyse.
...
Een belangrijk resultaat van dit onderzoek is de ontwikkeling van een high-level migratieframework dat IT-professionals binnen de organisatie ondersteunt bij het gecontroleerd migreren van Cool:Gen-applicaties naar andere programmeertalen, met behoud van functionele correctheid. Daarnaast wordt verwacht dat toepassing van dit framework bijdraagt aan verbeteringen op het vlak van performantie en onderhoudbaarheid van de gemigreerde applicatie. Deze verbeteringen zullen worden geëvalueerd aan de hand van objectieve metingen en vergelijkingen vóór en na de migratie, waardoor de impact van het voorgestelde framework op de kwaliteit van de applicatie aantoonbaar kan worden gemaakt.
